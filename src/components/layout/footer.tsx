        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
          ...
          <div className="md:col-span-4 flex flex-col items-center md:items-start gap-2 text-center md:text-left">
            <Link href="/" className="flex items-center space-x-2 mb-1.5">
               ...
               <span className="font-semibold text-lg text-accent">Goldsmith Connect</span> {/* Updated to text-accent */}
             </Link>
            <p className="text-xs text-muted-foreground max-w-xs leading-relaxed"> {/* Updated to text-muted-foreground */}
          ...
          <div className="md:col-span-2">
            <h3 className="font-semibold text-accent mb-2.5 text-sm">Company</h3> {/* Updated to text-accent */}
          ...
          <div className="md:col-span-2">
             <h3 className="font-semibold text-accent mb-2.5 text-sm">For Customers</h3> {/* Updated to text-accent */}
            <nav className="flex flex-col gap-1.5">
           ...
           <div className="md:col-span-2">
             <h3 className="font-semibold text-accent mb-2.5 text-sm">For Goldsmiths</h3> {/* Updated to text-accent */}
            <nav className="flex flex-col gap-1.5">
          ...
          <div className="md:col-span-2">
             <h3 className="font-semibold text-accent mb-2.5 text-sm">Legal</h3> {/* Updated to text-accent */}
            <nav className="flex flex-col gap-1.5">
