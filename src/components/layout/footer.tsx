...
export function Footer() {
  ...
  return (
    <footer className="w-full border-t border-border/20 bg-gradient-to-t from-background via-background to-secondary/10 py-6 md:py-8 mt-auto"> {/* Reduced padding */}
      <div className="container mx-auto px-4 md:px-6 max-w-screen-xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6 items-start"> {/* Reduced gap */}
          {/* Logo and Description */}
          <div className="md:col-span-4 flex flex-col items-center md:items-start gap-1.5 text-center md:text-left"> {/* Reduced gap */}
            <Link href="/" className="flex items-center space-x-2 mb-1"> {/* Reduced mb */}
            ...
            <p className="text-xs text-foreground/70 max-w-xs leading-snug"> {/* Adjusted leading */}
              Connecting you with local artisans to craft your dream jewelry through a secure, mediated process.
            </p>
             <p className="text-[0.7rem] text-muted-foreground/80 pt-1"> {/* Reduced pt */}
          ...
          <div className="md:col-span-2">
            <h3 className="font-semibold text-foreground mb-2 text-sm">Company</h3> {/* Reduced mb */}
            <nav className="flex flex-col gap-1"> {/* Reduced gap */}
          ...
          <div className="md:col-span-2">
             <h3 className="font-semibold text-foreground mb-2 text-sm">Admin & Legal</h3>
            <nav className="flex flex-col gap-1">
               <Link href="/admin" className={footerLinkClasses}>Admin Portal</Link>
               <Link href="/admin/dashboard" className={footerLinkClasses}>Admin Dashboard</Link>
