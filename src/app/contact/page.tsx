    ...
    <div className="flex justify-center items-center min-h-[calc(100vh-10rem)] py-12 bg-gradient-to-br from-background via-secondary/10 to-background">
      <Card className="w-full max-w-lg shadow-xl border-primary/20 rounded-xl bg-card">
        <CardHeader className="text-center pt-8 pb-4">
          ...
          <CardTitle className="text-3xl text-primary">Get in Touch</CardTitle> {/* CardTitle uses font-heading */}
          <CardDescription className="text-foreground/85 mt-1.5 text-sm">Have questions, feedback, or inquiries? We'd love to hear from you!</CardDescription>
        </CardHeader>
