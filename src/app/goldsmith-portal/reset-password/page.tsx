// src/app/goldsmith-portal/reset-password/page.tsx
'use client';
...
import { resetGoldsmithPasswordWithToken } from '@/actions/goldsmith-actions';
...
function ResetPasswordForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const result = await resetGoldsmithPasswordWithToken(token, newPassword);
      if (result.success) {
        setSuccess(true);
        toast({
