        ...
        <div className="md:col-span-1 space-y-5">
          <Card className="shadow-xl border-primary/15 rounded-xl overflow-hidden bg-card">
            <CardHeader className="items-center text-center bg-gradient-to-b from-card to-secondary/10 p-6">
              ...
              <CardTitle className="text-2xl text-foreground">{profile.name}</CardTitle> {/* CardTitle uses font-heading */}
              {profile.tagline && <p className="text-sm text-primary font-medium font-poppins">{profile.tagline}</p>}
              ...
              <CardDescription className="flex items-center justify-center text-muted-foreground text-sm pt-1">
               ...
               <div className="pt-2 flex flex-wrap justify-center gap-1.5">
                    {Array.isArray(profile.specialty) ? profile.specialty.map(spec => (
                        <Badge key={spec} variant="secondary" className="bg-primary/10 text-primary text-xs px-2 py-0.5 rounded-full shadow-sm font-poppins">{spec}</Badge>
                    )) : (
                        <Badge variant="secondary" className="bg-primary/10 text-primary text-xs px-2 py-0.5 rounded-full shadow-sm font-poppins">{profile.specialty}</Badge>
                    )}
                </div>
            </CardHeader>
        ...
        <div className="md:col-span-2 space-y-6">
            <Card className="shadow-xl border-primary/10 rounded-xl bg-card">
                <CardHeader className="p-5">
                    <CardTitle className="text-xl text-foreground">About {profile.name}</CardTitle> {/* CardTitle uses font-heading */}
                </CardHeader>
          ...
          <Card className="shadow-xl border-primary/10 rounded-xl bg-card">
            <CardHeader className="p-5">
              <CardTitle className="text-xl text-foreground">Portfolio Showcase</CardTitle> {/* CardTitle uses font-heading */}
           ...
           <Card className="shadow-xl border-primary/10 rounded-xl bg-card">
            <CardHeader className="p-5">
              <CardTitle className="text-xl text-foreground">Connect with {profile.name}</CardTitle> {/* CardTitle uses font-heading */}
