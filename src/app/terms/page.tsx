    ...
    <div className="container mx-auto max-w-4xl py-10 px-4 md:px-6">
       <Card className="shadow-lg border-primary/20 bg-card">
        ...
        <CardContent className="prose prose-stone dark:prose-invert max-w-none text-foreground/85 space-y-3 px-6 pb-6 pt-0">
            ...
            <p>Welcome to Goldsmith Connect. These Terms of Service (“Terms”) govern your access to and use of our website, platform, and services (“Platform”). By creating an account or using the Platform, you agree to these Terms and our Privacy Policy. If you do not agree, you may not use the Platform.</p>

            <h3 className="font-heading text-xl text-accent mt-4 mb-1.5">2. Our Service</h3>
            <p>Goldsmith Connect is a neutral marketplace that facilitates connections between Customers seeking custom jewellery and independent, third-party Goldsmiths. We are not:</p>
            ...
            <p>Goldsmiths undergo a verification process based on information they provide. While we aim to maintain quality, Goldsmith Connect does not guarantee the skill, reliability, or performance of any Goldsmith.</p>
            ...
            <p>We facilitate order requests but do not participate in negotiation, pricing, quality assurance, or delivery. Goldsmith Connect does not guarantee any outcome.</p>
            ...
            <p>Users must not engage in direct communication or payment outside the Platform for orders initiated here. Goldsmith Connect is not liable for losses due to off-platform transactions.</p>
            <p><strong>Disputes</strong></p>
            <p>Disputes between users (Customer vs Goldsmith) are not mediated by Goldsmith Connect. Users must resolve issues independently.</p>
            ...
            <p>You grant Goldsmith Connect a worldwide, royalty-free license to display and use your content for operating and promoting the Platform. This license ends when you delete your content or account.</p>
            ...
            <p>The Platform is provided “as is” without warranties. We do not guarantee uninterrupted, error-free, or secure service. Goldsmith Connect is not responsible for any damages resulting from user interactions or transactions.</p>
            ...
            <p>You agree to indemnify Goldsmith Connect from any claims, losses, or damages arising from: your use of the Platform, your content, or your violation of these Terms.</p>
