  ...
  return (
    <div className="container mx-auto max-w-4xl py-12 px-4 md:px-6">
       <Card className="shadow-lg border-primary/20 bg-card">
        <CardHeader>
           <CardTitle className="text-3xl text-foreground mb-4">Terms of Service</CardTitle> {/* CardTitle uses font-heading */}
        ...
        <CardContent className="prose prose-stone dark:prose-invert max-w-none text-foreground/85 space-y-4"> {/* Adjusted text color for body */}
            ...
            <h2 className="font-heading text-xl text-foreground">License</h2>
            ...
            <ul>
             ...
             <h2 className="font-heading text-xl text-foreground">User Content</h2>
            ...
            <h2 className="font-heading text-xl text-foreground">Disclaimer</h2>
