    ...
    <div className="container mx-auto max-w-4xl py-10 px-4 md:px-6"> {/* Reduced py */}
       <Card className="shadow-lg border-primary/20 bg-card">
        <CardHeader className="pb-3 pt-5"> {/* Reduced pb/pt */}
           <CardTitle className="text-3xl text-foreground mb-3">Terms of Service</CardTitle> {/* Reduced mb */}
        ...
        <CardContent className="prose prose-stone dark:prose-invert max-w-none text-foreground/85 space-y-3 px-6 pb-6 pt-0"> {/* Reduced space-y and px/pb */}
            ...
            <h2 className="font-heading text-xl text-foreground mt-4 mb-1.5">Cookies</h2> {/* Added mt, reduced mb */}
            ...
            <h2 className="font-heading text-xl text-foreground mt-4 mb-1.5">License</h2>
            ...
            <ul className="space-y-0.5"> {/* Reduced space-y */}
             ...
             <h2 className="font-heading text-xl text-foreground mt-4 mb-1.5">User Content</h2>
            ...
            <h2 className="font-heading text-xl text-foreground mt-4 mb-1.5">Disclaimer</h2>
            ...
            <p>[...]</p>
             <p className="pt-2"><strong>Please read the full Terms of Service carefully.</strong></p> {/* Added pt */}
        </CardContent>
      </Card>
    </div>
  );
