...
import { MapPin, Search, ShieldCheck, Gift, Handshake } from 'lucide-react';
  ...
  <div className="absolute inset-0 opacity-[0.02] [mask-image:radial-gradient(farthest-side_at_top_left,white,transparent)]">
    <svg aria-hidden="true" className="absolute inset-0 h-full w-full">
      <defs>
        ...
        >
          <path d="M0 80L80 0ZM80 80L0 0Z" className="stroke-primary/30 fill-none"></path>
        </pattern>
      </defs>
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row pt-1">
                 <Link
                   ...
                   className={cn(
                     ...
                     'shadow-md hover:shadow-lg transition-shadow rounded-full px-6 py-2 text-base'
                   )}
                 >
                   <span>
                     Find a Goldsmith
                 ...
                 <Link
                   ...
                   className={cn(
                     ...
                     'shadow-md hover:shadow-lg transition-shadow border-accent text-accent hover:bg-accent/10 rounded-full px-6 py-2 text-base'
                   )}
                 >
                   <span>
                     Join as a Goldsmith
                     <GoldsmithIcon className="ml-2 h-4 w-4 inline" />
                   </span>
                 </Link>
              </div>
            </div>
        ...
        <div className="container grid items-center justify-center gap-2.5 px-4 text-center md:px-6">
          ...
          <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center pt-1">
              ...
              <Link
                ...
                className={cn(
                  buttonVariants({ size: 'default', variant: 'outline' }),
                  'shadow-md hover:shadow-lg transition-shadow border-accent text-accent hover:bg-accent/10 rounded-full px-6 py-2 text-sm'
                )}
              >
                <span>
