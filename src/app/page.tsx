          ...
          <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center pt-1">
              <Link
                 ...
                 className={cn(
                   ...
                   'shadow-md hover:shadow-lg transition-shadow bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-6 py-2 text-sm'
                 )}
               >
                 <span>
                   Start Your Search
              ...
              <Link
                ...
                className={cn(
                  ...
                  'shadow-md hover:shadow-lg transition-shadow border-accent text-accent hover:bg-accent/10 hover:text-accent-foreground rounded-full px-6 py-2 text-sm'
                )}
              >
                <span>
