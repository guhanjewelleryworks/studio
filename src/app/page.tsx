...
import { Gem, Search, UserCheck, ShieldCheck, Gift, Handshake } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center bg-background text-foreground">
      {/* Hero Section */}
      <section className="relative w-full py-12 md:py-16 lg:py-20 bg-gradient-to-br from-secondary/20 via-background to-background overflow-hidden">
        <HeroPattern />
        <div className="container px-4 md:px-6 relative z-10">
          <div className="grid gap-6 lg:grid-cols-[1fr_500px] lg:gap-8 xl:grid-cols-[1fr_550px] items-center">
            <div className="flex flex-col justify-center space-y-2">
              <div className="space-y-1.5">
                <h1 className="font-heading text-3xl font-bold tracking-tight sm:text-4xl xl:text-5xl/none text-foreground leading-tight">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row pt-1">
                <Link
                  href="/discover"
                  className={cn(buttonVariants({ size: 'lg' }), "shadow-md hover:shadow-lg transition-shadow rounded-full px-6 py-3 text-sm")}
                >
                  <span>Find a Goldsmith <Search className="ml-1.5 h-4 w-4 inline" /></span>
                </Link>
                <Link
                  href="/goldsmith-portal"
                  className={cn(buttonVariants({ variant: 'outline', size: 'lg' }), "shadow-md hover:shadow-lg transition-shadow border-accent text-accent hover:bg-accent/10 hover:text-accent rounded-full px-6 py-3 text-sm")}
                >
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-2 text-center">
            <div className="space-y-1">
              ...
              <h2 className="font-heading text-2xl font-bold tracking-tight sm:text-3xl text-foreground">Your Secure Path to Custom Jewelry</h2>
      ...
      <section className="w-full py-12 md:py-16 lg:py-20 bg-gradient-to-b from-secondary/20 to-background">
        <div className="container grid items-center justify-center gap-3 px-4 text-center md:px-6">
          <div className="space-y-1.5">
            <h2 className="font-heading text-2xl font-bold tracking-tight md:text-3xl/tight text-foreground">Meet Our Talented Artisans</h2>
              ...
              <Card key={goldsmith.id} className="shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out transform hover:-translate-y-1 bg-card border-primary/10 overflow-hidden group rounded-xl">
                ...
                <CardContent className="p-2.5 text-left space-y-0.5">
                  ...
                  <p className="flex items-center text-foreground/70 text-[0.7rem]">
                    <Gem className="mr-1.5 h-3 w-3 text-muted-foreground" /> {goldsmith.specialty}
                  </p>
          ...
          <div className="mt-6 md:mt-8">
            <Link
              href="/discover"
              className={cn(buttonVariants({ size: 'lg', variant: 'outline' }), "border-primary text-primary hover:bg-primary/10 shadow-md hover:shadow-lg transition-shadow rounded-full px-6 py-2.5 text-sm")}
            >
      ...
      <section className="w-full py-12 md:py-16 lg:py-20 border-t border-border/10 bg-gradient-to-t from-secondary/10 to-background">
        <div className="container grid items-center justify-center gap-2.5 px-4 text-center md:px-6">
          <div className="space-y-1.5">
            ...
            <h2 className="font-heading text-2xl font-bold tracking-tight md:text-3xl/tight text-foreground">
          ...
          <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center pt-1">
            <Link
              href="/discover"
              className={cn(buttonVariants({ size: 'lg' }), "shadow-md hover:shadow-lg transition-shadow rounded-full px-6 py-2.5 text-sm")}
            >
              <span>Start Your Search <Search className="ml-1.5 h-4 w-4 inline" /></span>
            </Link>
            <Link
              href="/goldsmith-portal/register"
              className={cn(buttonVariants({ variant: 'outline', size: 'lg' }), "shadow-md hover:shadow-lg transition-shadow border-accent text-accent hover:bg-accent/10 hover:text-accent rounded-full px-6 py-2.5 text-sm")}
            >
