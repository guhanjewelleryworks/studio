  ...
  return (
    <div className="container mx-auto max-w-4xl py-12 px-4 md:px-6">
       <Card className="shadow-lg border-primary/20 bg-card">
         <CardHeader>
           <CardTitle className="text-3xl text-foreground mb-4">Privacy Policy</CardTitle> {/* CardTitle uses font-heading */}
            <p className="text-sm text-muted-foreground">Last Updated: {new Date().toLocaleDateString()}</p>
         </CardHeader>
        <CardContent className="prose prose-stone dark:prose-invert max-w-none text-foreground/85 space-y-4"> {/* Adjusted text color for body */}
            ...
            <h2 className="font-heading text-xl text-foreground">Log Files</h2>
            <p>Goldsmith Connect follows a standard procedure of using log files. These files log visitors when they visit websites. [...]</p>

            <h2 className="font-heading text-xl text-foreground">Cookies and Web Beacons</h2>
            <p>Like any other website, Goldsmith Connect uses 'cookies'. [...]</p>

            <h2 className="font-heading text-xl text-foreground">Third Party Privacy Policies</h2>
            <p>Goldsmith Connect's Privacy Policy does not apply to other advertisers or websites. [...]</p>

            <h2 className="font-heading text-xl text-foreground">Your Data Protection Rights</h2>
            ...
            <p>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</p>
             ...
             <h2 className="font-heading text-xl text-foreground">Children's Information</h2>
