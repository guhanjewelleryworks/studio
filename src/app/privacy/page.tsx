  ...
  return (
    <div className="container mx-auto max-w-4xl py-12 px-4 md:px-6">
       <Card className="shadow-lg border-primary/20 bg-card">
         <CardHeader>
           <CardTitle className="text-3xl font-bold text-foreground mb-4">Privacy Policy</CardTitle>
        ...
        <CardContent className="prose prose-stone dark:prose-invert max-w-none text-foreground space-y-4">
            ...
            <h2 className="text-xl font-semibold text-foreground">Third Party Privacy Policies</h2>
            <p>Goldsmith Connect's Privacy Policy does not apply to other advertisers or websites. [...]</p>

            <h2 className="text-xl font-semibold text-foreground">Your Data Protection Rights</h2>
            ...
            <p>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</p>
             ...
             <h2 className="text-xl font-semibold text-foreground">Children's Information</h2>
